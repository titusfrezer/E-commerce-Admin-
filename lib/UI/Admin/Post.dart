...
import 'package:loginui/variables/AdminMultiSelect.dart';
              ...
              : FlatButton(
                    ...
                    onPressed: () async {
                      ...
                      if(connectivity == ConnectivityResult.mobile || connectivity == ConnectivityResult.wifi) {
                        ...
                        if(productCategory.text.isNotEmpty&&productName.text.isNotEmpty&&productDetail.text.isNotEmpty&&productPrice.text.isNotEmpty&&images.length==3&&categoryImage.length==1){
                          ...
                          await uploadtoFirebase(images,categoryImage,user);
                          if(counter==0){
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: TextField(
                                    ...
                                    maxLines: 5,
                                    cursorColor: fontWhite,
                                    controller: productDetail,keyboardType: TextInputType.text,
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Container(
                                      child: AutoSizeText('Select Category Image',
                                          maxLines: 1,
                                          minFontSize: 17,
                                          style: TextStyle(
                                              color: fontWhite,
...
Future<String>upload(Asset Image)   async {
  ...
  ByteData byteData = await Image.getByteData(quality: 1);
...
//print(listurl);
/*
Uri downurl = (await uploadTask.future).downloadurl;
...
Future uploadtoFirebase(List<Asset> Image,List<Asset> categoryImages,FirebaseUser user) async{
  ...
  for (var i=0;i<Image.length;i++){
   ...
   var categoryUrl = await upload(categoryImages[0]);
  listurl.add(categoryUrl);
  print(listurl.length);
